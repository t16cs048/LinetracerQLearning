...
public class View extends JPanel {
    ...
    public void paintComponent(Graphics g) {
        ...
        int light_color = model.getColor(1);
        int light_colorL = model.getColor(0);
        int light_colorR = model.getColor(2);

        //System.out.println("in~!!"+light_color);
        // アフィン変換オブジェクトの生成
        ...
        g.drawString("Miss: " + miss + "cm", 10, 60);
        g.setColor(Color.BLACK);
        if (light_color == 1) g.drawString("Line Color: GREEN", 10, 80);
        else if (light_color == 2) g.drawString("Line Color: BLACK", 10, 80);
        else if (light_color == 3) g.drawString("Line Color: RED", 10, 80);
        else if (light_color == 4) g.drawString("Line Color: BLUE", 10, 80);
        else g.drawString("Line Color: WHITE", 10, 80);

        if (light_colorL == 1) g.drawString("Line Color L: GREEN", 10, 100);
        else if (light_colorL == 2) g.drawString("Line Color L: BLACK", 10, 100);
        else if (light_colorL == 3) g.drawString("Line Color L: RED", 10, 100);
        else if (light_colorL == 4) g.drawString("Line Color L: BLUE", 10, 100);
        else g.drawString("Line Color L: WHITE", 10, 100);

        if (light_colorR == 1) g.drawString("Line Color R: GREEN", 10, 120);
        else if (light_colorR == 2) g.drawString("Line Color R: BLACK", 10, 120);
        else if (light_colorR == 3) g.drawString("Line Color R: RED", 10, 120);
        else if (light_colorR == 4) g.drawString("Line Color R: BLUE", 10, 120);
        else g.drawString("Line Color R: WHITE", 10, 120);
